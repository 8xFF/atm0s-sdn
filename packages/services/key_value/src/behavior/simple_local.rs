...
struct KeySlotGetCallback {
    ...
    callback: Box<dyn FnOnce(Result<Option<(ValueType, KeyVersion)>, SimpleKeyValueGetError>)>,
}
...
impl LocalStorage {
    ...
    pub fn subscribe(&mut self, key: KeyId, ex: Option<u64>) {
