...
mod test {
    ...
    fn should_not_forward_invalid_msg() {
        ...
        let mut trans_msg = TransportMsg::build(KEY_VALUE_SERVICE_ID, RouteRule::Direct, 0, 0, &vec![]);
    ...
    fn should_forward_valid_msg() {
        ...
        let mut header = MsgHeader::build(KEY_VALUE_SERVICE_ID, RouteRule::Direct);
