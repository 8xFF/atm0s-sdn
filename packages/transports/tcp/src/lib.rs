...
mod tests {
    ...
    async fn simple_network() {
        let node_addr_builder1 = Arc::new(NodeAddrBuilder::new(1));
        let tran1 = TcpTransport::new(10001, node_addr_builder1.clone()).await;

        let node_addr_builder2 = Arc::new(NodeAddrBuilder::new(2));
        let tran2 = TcpTransport::new(10002, node_addr_builder2.clone()).await;
    ...
    async fn simple_network_connect_addr_not_found() {
        let node_addr_builder1 = Arc::new(NodeAddrBuilder::new(1));
        let tran1 = TcpTransport::new(20001, node_addr_builder1.clone()).await;
    ...
    async fn simple_network_connect_wrong_node() {
        let node_addr_builder1 = Arc::new(NodeAddrBuilder::new(1));
        let tran1 = TcpTransport::new(30001, node_addr_builder1.clone()).await;

        let node_addr_builder2 = Arc::new(NodeAddrBuilder::new(2));
        let tran2 = TcpTransport::new(30002, node_addr_builder2.clone()).await;
